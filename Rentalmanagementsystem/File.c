...
{    
    ...
    FILE* fp = fopen("/Users/macbook/Desktop/Rentalmanagementsystem/data/tenant/Tenant Information.txt", "a+");
...
{    
    ...
    FILE* fp = fopen("/Users/macbook/Desktop/Rentalmanagementsystem/data/tenant/Tenant Information.txt", "w");
    fprintf(fp, "房间号\t姓名\t性别\t电话\t身份证\n");
    while (tempNode != NULL)
    {
        fprintf(fp, "-------------------------------------------------\n");
...
void WritePeopleDataManagement(struct PeopleNode* head)
{
    ...
    FILE* fp = fopen("/Users/macbook/Desktop/Rentalmanagementsystem/data/tenant/test.txt", "a+");
    while (tempNode != NULL)
    {
        fprintf(fp, "%s\t%s\t%s\t%s\t%s\n", tempNode->people->number, tempNode->people->name, tempNode->people->sex, tempNode->people->phone, tempNode->people->ID);
        tempNode = tempNode->next;
...
void UpdatePeopleDataManagement(struct PeopleNode* head)
{
    ...
    FILE* fp = fopen("/Users/macbook/Desktop/Rentalmanagementsystem/data/tenant/test.txt", "w");
    while (tempNode != NULL)
    {
        fprintf(fp, "%s\t%s\t%s\t%s\t%s\n", tempNode->people->number, tempNode->people->name, tempNode->people->sex, tempNode->people->phone, tempNode->people->ID);
        tempNode = tempNode->next;
...
struct PeopleNode* ReadPeopleData(struct PeopleNode* head)
{
    ...
    FILE* fp = fopen("/Users/macbook/Desktop/Rentalmanagementsystem/data/tenant/test.txt", "r");
...
void WriteRoomDataUser(struct RoomNode* head)
{
    ...
    FILE* fp = fopen("/Users/macbook/Desktop/Rentalmanagementsystem/data/room/Room Infomation.txt", "a+");
...
void UpdateRoomDataUser(struct RoomNode* head)
{
    ...
    FILE* fp = fopen("/Users/macbook/Desktop/Rentalmanagementsystem/data/room/Room Infomation.txt", "w");
    fprintf(fp, "房间号\t入住日期\t到期日期\t当前电表\t当前水表\t租金(一个月)\t房间状态(1为有人,0为无人)\n");
    while (tempNode != NULL)
    {
        fprintf(fp, "--------------------------------------------------------\n");
...
void WriteRoomDataManagement(struct RoomNode* head)
{
    ...
    FILE* fp = fopen("/Users/macbook/Desktop/Rentalmanagementsystem/data/room/test.txt", "a+");
    while (tempNode != NULL)
    {
        fprintf(fp, "%s\t%s\t%s\t%lf\t%lf\t%lf\t%d\n", tempNode->room->number, tempNode->room->in, tempNode->room->out, tempNode->room->electricity, tempNode->room->water, tempNode->room->price, tempNode->room->state);
        tempNode = tempNode->next;
...
void UpdateRoomDataManagement(struct RoomNode* head)
{
    ...
    FILE* fp = fopen("/Users/macbook/Desktop/Rentalmanagementsystem/data/room/test.txt", "w");
    while (tempNode != NULL)
    {
        fprintf(fp, "%s\t%s\t%s\t%lf\t%lf\t%lf\t%d\n", tempNode->room->number, tempNode->room->in, tempNode->room->out, tempNode->room->electricity, tempNode->room->water, tempNode->room->price, tempNode->room->state);
        tempNode = tempNode->next;
...
struct RoomNode* ReadRoomData(struct RoomNode* head)
{
    ...
    FILE* fp = fopen("/Users/macbook/Desktop/Rentalmanagementsystem/data/room/test.txt", "r");
